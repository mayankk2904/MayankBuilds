  ...
  return (
    <Card className="bg-card border-border col-span-1 flex flex-col overflow-hidden">
      <CardContent className="p-0">
        ...
        <div className="relative bg-gradient-to-b from-muted to-muted px-6 py-4 sm:px-10 sm:py-6 border-b border-border overflow-hidden">
