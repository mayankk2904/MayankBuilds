      ...
      <CardContent className="p-0">
        ...
        <div className="bg-gradient-to-r from-zinc-800/50 to-zinc-900/50 p-4 sm:p-6 flex flex-col items-center border-b border-zinc-800">
          <div className="flex flex-col sm:flex-col items-center w-full">
            <div className="relative w-24 h-24 sm:w-28 sm:h-28 rounded-full overflow-hidden mb-4 border-2 border-brand/30 ring-4 ring-zinc-800/50">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-brand mb-1">{personalInfo.title}</p>
            ...
            <TabsList className="w-full bg-transparent border-b border-zinc-800 rounded-none h-auto p-0">
              <TabsTrigger
                ...
                className={`flex-1 rounded-none border-b-2 px-2 sm:px-4 py-2 text-xs sm:text-sm ${
                  activeTab === "about" ? "border-brand text-brand" : "border-transparent text-zinc-400"
                }`}
              >
              ...
              <TabsTrigger
                value="contact"
                className={`flex-1 rounded-none border-b-2 px-2 sm:px-4 py-2 text-xs sm:text-sm ${
                  activeTab === "contact" ? "border-brand text-brand" : "border-transparent text-zinc-400"
                }`}
              >
                ...
                {aboutInfo.languages.map((language, index) => (
                  <div key={index} className="space-y-1">
                    ...
                    <div className="h-1.5 bg-zinc-800 rounded-full overflow-hidden">
                      <div className="h-full bg-gradient-to-r from-brand to-orange-500 rounded-full" 
