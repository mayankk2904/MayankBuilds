  ...
  if (isSubmitted) {
    return (
      <div className="flex flex-col items-center justify-center p-6">
        <div className="w-16 h-16 mb-4 rounded-full bg-gradient-to-r from-orange-500 to-red-500 flex items-center justify-center">
            ...
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  ...
                  className="bg-zinc-800/50 border-zinc-700 focus:border-orange-500 min-h-[120px]"
                  {...field}
                />
              </FormControl>
              <FormMessage className="text-xs text-red-500" />
