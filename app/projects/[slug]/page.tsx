          ...
          <AnimatedSection animation="fade-up" className="lg:col-span-3">
            <Card className="bg-card border-border backdrop-blur-sm overflow-hidden">
              <div className="relative h-48 sm:h-64 md:h-80 w-full">
                ...
                {/* Overlay: light mode uses white-tinted overlay, dark mode uses black-tinted overlay */}
              ...
              <Card className="bg-card border-border backdrop-blur-sm">
                <CardContent className="p-4 sm:p-6">
                  ...
                  <AnimatedSection animation="fade-up" delay={200}>
                    ...
                    <ul className="list-disc pl-5 space-y-1 sm:space-y-2 text-sm sm:text-base text-foreground">
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <div className="space-y-3 sm:space-y-4">
                    <div>
                      ...
                      <p className="text-sm sm:text-base text-foreground">{project.client || "Personal Project"}</p>
                    </div>

                    <div>
                      <h3 className="text-xs sm:text-sm font-medium text-muted-foreground">Timeline</h3>
                      <p className="text-sm sm:text-base text-foreground">{project.timeline}</p>
                    </div>

                    <div>
                      <h3 className="text-xs sm:text-sm font-medium text-muted-foreground">Role</h3>
                      <p className="text-sm sm:text-base text-foreground">{project.role}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                        ...
                        <AnimatedSection key={index} animation="fade-up" delay={100 * (index + 1)}>
                          <Link href={`/projects/${related.slug}`} className="block group">
                            <div className="flex items-center gap-2 sm:gap-3">
                              <div className="relative w-12 h-12 sm:w-16 sm:h-16 rounded overflow-hidden flex-shrink-0 border border-border">
                                <Image
