            ...
            <Card className="bg-zinc-900/70 border-zinc-800 backdrop-blur-sm overflow-hidden">
              <div className="relative h-48 sm:h-64 md:h-80 w-full">
                ...
                <div className="absolute bottom-0 left-0 p-4 sm:p-6">
                  <div className="text-xs sm:text-sm text-brand mb-1 sm:mb-2">{project.category}</div>
                        ...
                        <AnimatedSection key={index} animation="fade-up" delay={100 * (index + 1)}>
                          <Link href={`/projects/${related.slug}`} className="block group">
                            <div className="flex items-center gap-2 sm:gap-3">
                              ...
                              <div>
                                <h3 className="text-sm sm:text-base font-medium group-hover:text-brand transition-colors">
                                  {related.title}
                                </h3>
